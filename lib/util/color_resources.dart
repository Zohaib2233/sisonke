...
class ColorResources {
  ...
  static Color getLight(BuildContext context) {
  ...
  static const Color DARK_GREEN = Color(0xff62B334);
  ...
  static const Color LIGHT_YELLOW = Color(0xFFF5BD1D);
  static const Color HINT_TEXT_COLOR = Color(0xff9E9E9E);
  static const Color PROFILE_BUTTON = Color(0xffF3F3F3);
  ...
  static const Color DARK_BLUE = Color(0xff160062);
  static const Color LIGHT_BLUE = Color(0xff00A1B5);
  static const Color COLOR_ACCENT = Color(0xFFFF742E);
  static const Color SILVER_GREY = Color(0xFF969AA8);
  static const Color ORANGE = Color(0xFFEC6B2C);
  static const Color LIGHT_RED = Color(0xFFDE0050);
  static const Color DARK_RED = Color(0xFFF21010);
